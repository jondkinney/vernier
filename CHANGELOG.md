...
## [0.5.2](https://github.com/jondkinney/vernier/compare/v0.5.1...v0.5.2) - 2026-09-05

### Fixed

- *(packaging)* provide grim for fresh Wayland captures
- *(capture)* use fresh frames for measurement activation and refresh

## [0.5.1](https://github.com/jondkinney/vernier/compare/v0.5.0...v0.5.1) - 2026-09-05

### Fixed

- *(macos)* remove the tray item before stopping the event loop
- *(handoff)* recognize Omasnap as an annotation app
- *(omarchy)* expose only the root plugin manifest
- *(wayland)* keep rebuilt hidden overlays from taking focus
